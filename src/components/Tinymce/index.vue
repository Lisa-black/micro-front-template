...
import EditorImageUpload, { MyUploadObject } from './components/EditorImage.vue'
...
export default class extends Vue {
  ...
  get initOptions () {
    return {
      ...
      languageUrl: this.language === 'en' ? '' : `${process.env.BASE_URL}tinymce/langs/${this.language}.js`,
      skinUrl: `${process.env.BASE_URL}tinymce/skins/`,
      emoticonsDatabaseUrl: `${process.env.BASE_URL}tinymce/emojis.min.js`,
      endContainerOnEmptyBlock: true,
      powerpasteWordImport: 'clean',
      codeDialogHeight: 450,
      codeDialogWidth: 1000,
      advlistBulletStyles: 'square',
      advlistNumbeStyles: 'default',
      imagetoolsCorsHosts: ['www.tinymce.com', 'codepen.io'],
      defaultLinkTarget: '_blank',
      linkTitle: false,
      // inserting nonbreaking space &nbsp; need Nonbreaking Space Plugin
      nonbreakingForceTab: true,
  ...
  private imageSuccessCBK (arr: MyUploadObject[]) {
