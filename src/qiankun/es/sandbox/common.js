...
export function getTargetValue (target, value) {
  ...
  if (typeof value === 'function' && !isConstructable(value)) {
    ...
    const boundValue_1 = value.bind(target) // some callable function has custom fields, we need to copy the enumerable props to boundValue. such as moment function.
