...
const isSlowNetwork = navigator.connection ? navigator.connection.saveData || /(2|3)g/.test(navigator.connection.effectiveType) : false
/**
...
function prefetch (entry, opts) {
  ...
  requestIdleCallback(function () {
    return __awaiter(_this, void 0, void 0, function () {
      let _a, getExternalScripts, getExternalStyleSheets
...
function prefetchAfterFirstMounted (apps, opts) {
  window.addEventListener('single-spa:first-mount', function listener () {
    ...
    const notMountedApps = apps.filter(function (app) {
...
export function doPrefetchStrategy (apps, prefetchStrategy, importEntryOpts) {
  ...
  const appsName2Apps = function appsName2Apps (names) {
  ...
  if (Array.isArray(prefetchStrategy)) {
    ...
    (function () {
      return __awaiter(_this, void 0, void 0, function () {
        let _a, _b, criticalAppNames, _c, minorAppsName
